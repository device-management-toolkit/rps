...
export const proxiesValidator = (): any => [
  check('proxyName')
    .not()
    .isEmpty()
  ...
  check('networkDnsSuffix')
    ...
    .withMessage('Domain name of the network should contain alphanumeric and hyphens')
    .isLength({ max: 192 })
    .withMessage('Proxy profile name maximum length is 192'),
  ]
